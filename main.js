...
const buttonOpenOneTutorial = document.querySelector(".button_open_one_tutorial");
const buttonOpenFiveTutorial = document.querySelector(".button_open_five_tutorial");
...
const tutorialSection = document.querySelector(".tutorial_section")

buttonOpenOneTutorial.addEventListener("click", () => {
...
buttonOpenFiveTutorial.addEventListener("click", () => {
